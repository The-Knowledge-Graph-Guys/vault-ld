...
[![License](https://img.shields.io/github/license/The-Knowledge-Graph-Guys/vault-ld?color=blue)](https://github.com/The-Knowledge-Graph-Guys/vault-ld/blob/main/LICENSE)
...
See **[EXPORT.md](https://github.com/The-Knowledge-Graph-Guys/vault-ld/blob/main/scripts/EXPORT.md)** for the full usage guide, flags, and how layer classification and context composition work.
...
See **[INGEST.md](https://github.com/The-Knowledge-Graph-Guys/vault-ld/blob/main/scripts/INGEST.md)** for the full usage guide and the fidelity rules. Because the two tools are inverses, `vault → RDF → vault` is a no-op and `RDF → vault → RDF` is graph-isomorphic.
...
[Apache License 2.0](https://github.com/The-Knowledge-Graph-Guys/vault-ld/blob/main/LICENSE).
